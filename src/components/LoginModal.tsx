                    ...
                    <div className="relative">
                      ...
                      >
                        {showPassword ? (
                          ...
                          <Eye className="w-4 h-4 text-slate-400 hover:text-blue-900" />
                        )}
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                      ...
                      <div className="relative">
                        ...
                        >
                          {showRegPassword ? <EyeOff className="w-3.5 h-3.5 text-blue-900" /> : <Eye className="w-3.5 h-3.5 text-slate-400 hover:text-blue-900" />}
                        </button>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        >
                          {showRegConfirmPassword ? <EyeOff className="w-3.5 h-3.5 text-blue-900" /> : <Eye className="w-3.5 h-3.5 text-slate-400 hover:text-blue-900" />}
                        </button>
                      </div>
                    </div>
                  </div>
