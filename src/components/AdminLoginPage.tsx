                  ...
                  <div className="relative">
                    ...
                    >
                      {showPassword ? (
                        ...
                        <Eye className="w-4 h-4 text-slate-400 hover:text-[#1E3A8A]" />
                      )}
                    </button>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                      ...
                      <div className="relative">
                        ...
                        >
                          {showRegPassword ? <EyeOff className="w-4 h-4 text-amber-600" /> : <Eye className="w-4 h-4 text-slate-400 hover:text-amber-600" />}
                        </button>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        >
                          {showRegConfirmPassword ? <EyeOff className="w-4 h-4 text-amber-600" /> : <Eye className="w-4 h-4 text-slate-400 hover:text-amber-600" />}
                        </button>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="relative">
                      ...
                      >
                        {showNewPassword ? (
                          ...
                          <Eye className="w-4 h-4 text-slate-400 hover:text-sky-600" />
                        )}
                      </button>
                    </div>
                  </div>
